    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="order in orderInfo.detailArrayList" :key="order.skuId">
          <li>
            <img :src="order.imgUrl" alt="" style="witdh:100px;height:100px">
          </li>
          <li>
            <p>
              {{order.skuName}}</p>
  ...
  export default {
    ...
    methods: {
      ...
      async submitOrder() {
        ...
        // 其余的六个参数
        let data = {
          consignee:this.userDefaultAddress.consignee, // 最终收件人的姓名
          consigneeTel:this.userDefaultAddress.phoneNum,// 最终收件人的电话号
