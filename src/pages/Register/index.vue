  ...
  export default {
    ...
    methods: {
      ...
      async userRegister() {
        // try {
        //   // 如果成功--路由跳转
        //   const {phone, code, password, repeatpassword} = this
        //   
        try {
          const {phone, code, password, repeatpassword} = this;
          (phone&&code&&password==repeatpassword) && await this.$store.dispatch('userRegister', {phone, code, password})
